...
export function KatalogPage() {
  ...
  return (
    <AppLayout>
      ...
      {/* Izbor predmeta */}
      <div className="bg-card rounded-2xl shadow-xl shadow-gray-200/50 border border-border p-4 flex items-center gap-3">
      ...
      {izabraniPredmet && (
        <div className="grid lg:grid-cols-5 gap-6">
          {/* Leva kolona: Teme */}
          <section className="lg:col-span-2 bg-card rounded-2xl shadow-xl shadow-gray-200/50 border border-border overflow-hidden flex flex-col">
